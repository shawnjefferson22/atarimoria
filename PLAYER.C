...
/* Low code always banked in stuff */
#pragma bss-name("BSS")

/* Player record for most player related info */
player_type py;
/* player location in dungeon */
//int8u char_row;                   // in zeropage -SJ
//int8u char_col;                   // in zeropage -SJ


/* Player Structures bank */
...
int8u class_level_adj[MAX_CLASS][MAX_LEV_ADJ] = {                                                        // was int16
